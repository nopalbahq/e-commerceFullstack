...
{
    /// <inheritdoc />
    public partial class SqlServerInitialze : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliverFee = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "b1306a83-1b44-4964-98b1-04ff7e80d52e", "Admin", "Admin", "ADMIN" },
                    { "de805d56-4acc-4c7b-b2e8-00a3c7168f8e", "Member", "Member", "MEMBER" }
                });
