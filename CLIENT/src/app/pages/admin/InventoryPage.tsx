...
import { useGetFetchProductsQuery } from "../catalog/catalogApi";
import {
  Box,
  Button,
  Paper,
...
export default function InventoryPage() {
  ...
  const { data, refetch } = useGetFetchProductsQuery(productParams);
              ...
              data.items.map((product) => (
                ...
                >
                  ...
                  <TableCell align="right">
                    <Button onClick={() => handleSelectProduct(product)} startIcon={<Edit />}></Button>
                    <Button
